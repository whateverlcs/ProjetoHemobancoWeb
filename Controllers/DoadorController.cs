...
namespace ProjetoHemobancoWeb.Controllers
{
    ...
    public class DoadorController : Controller
    {
        ...
        public IActionResult Create([Bind("Nome,Cpf,Idade,Email,DataNascimento,Cep,Logradouro,Bairro,Localidade,Uf,Telefone,Celular,Id,CriadoEm")] Doador doador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(int id, [Bind("Nome,Cpf,Idade,Email,DataNascimento,Cep,Logradouro,Bairro,Localidade,Uf,Telefone,Celular,Id,CriadoEm")] Doador doador)
        {
            if (id != doador.Id)
            {
                return NotFound();
